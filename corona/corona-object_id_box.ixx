...
export module corona:object_id_box;
...
export int compare(const object_id_box& a, const object_id_box& b);

export int operator<(const object_id_box& a, const object_id_box& b);
export int operator>(const object_id_box& a, const object_id_box& b);
export int operator>=(const object_id_box& a, const object_id_box& b);
export int operator<=(const object_id_box& a, const object_id_box& b);
export int operator==(const object_id_box& a, const object_id_box& b);
...
export template<typename T> std::ostream& operator <<(std::ostream& output, object_id_box& src)
{
	output << (T)src;
	return output;
}
