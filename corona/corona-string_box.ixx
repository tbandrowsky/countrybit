...
export module corona:string_box;
import "corona-windows-lite.h";
import :store_box;
import :assert_if;
import :constants;

export struct string_box_data {
public:
	uint32_t length;
	int last_char;
	char data[1];
...
export template <int len> class istring;
export template <int len> class iwstring;

export bool str_has_any(const char* _src, const char* _charlist)
{
...
export int get_hash_code(const char* _src);

export std::string operator+(const string_box& a, const char* b);
export std::string operator+(const char* b, const string_box& a);
export std::string operator+(const string_box& a, const std::string& b);
export std::string operator+(const std::string& b, const string_box& a);
export std::ostream& operator <<(std::ostream& output, string_box& src);

export template <int32_t length_bytes> class istring
{
	int32_t length;
	int32_t last_char;
...
export template<int l1, int l2> int compare(const istring<l1>& a, const istring<l2>& b)
{
	return strcmp(a.c_str(), b.c_str());
}

export template<int l1, int l2> bool operator<(const istring<l1>& a, const istring<l2>& b)
{
...
export template<int l1> int compare(const istring<l1>& a, const char* b)
{
	return strcmp(a.c_str(), b);
}

export template<int l1> bool operator<(const istring<l1>& a, const char* b)
{
	return compare(a, b) < 0;
}
...
export template<int l1, int l2> std::string operator+(const istring<l1>& a, const istring<l1>& b)
{
...
export template<int l1> std::string operator+(const istring<l1>& a, const char* b)
{
	std::string temp = a.c_str();
	temp += b;
	return temp;
...
export template<int l1> std::string operator+(const char* b, const istring<l1>& a)
{
	std::string temp = b;
	temp += a.c_str();
	return temp;
...
export template<int l1> std::string operator+(const istring<l1>& a, const std::string& b)
{
	std::string temp = a.c_str();
	temp += b;
	return temp;
...
export template<int l1> std::string operator+(const std::string& b, const istring<l1>& a)
{
	std::string temp = b;
	temp += a.c_str();
	return temp;
...
export template<int l1> std::ostream& operator <<(std::ostream& output, istring<l1>& src)
{
	output << src.c_str();
	return output;
}
...
export template <int length_wchars> class iwstring
{
	uint32_t length;
	int last_char;
...
export template<int l1, int l2> int compare(const iwstring<l1>& a, const iwstring<l2>& b)
{
	return wcscmp(a.c_str(), b.c_str());
}

export template<int l1, int l2> bool operator<(const iwstring<l1>& a, const iwstring<l2>& b)
{
	return compare(a, b) < 0;
}
...
export template<int l1> bool compare(const iwstring<l1>& a, const wchar_t* b)
{
	return wcscmp(a.c_str(), b);
}

export template<int l1> bool operator<(const iwstring<l1>& a, const wchar_t* b)
{
	return compare(a, b) < 0;
}
...
export template<int l1> std::wstring operator+(const iwstring<l1>& a, const wchar_t* b)
{
...
export template<int l1> std::wstring operator+(const wchar_t* b, const iwstring<l1>& a)
{
	std::wstring temp = b;
	temp += a.c_str();
	return temp;
...
export template<int l1> std::wstring operator+(const iwstring<l1>& a, const std::wstring& b)
{
	std::wstring temp = a.c_str();
	temp += b;
	return temp;
...
export template<int l1> std::wstring operator+(const std::wstring& b, const iwstring<l1>& a)
{
	std::wstring temp = b;
	temp += a.c_str();
	return temp;
...
export template<int l1> std::ostream& operator <<(std::ostream& output, iwstring<l1>& src)
{
	output << src.c_str();
	return output;
}
...
export template<int l1, int l2> int compare(const iwstring<l1>& a, const istring<l2>& b)
{
	iwstring<l2> temp = b;
	return wcscmp(a.c_str(), temp.c_str());
}

export template<int l1, int l2> bool operator<(const iwstring<l1>& a, const istring<l2>& b)
{
	return compare(a, b) < 0;
}
...
export template<int l1, int l2> int operator!=(const iwstring<l1>& a, const istring<l2>& b)
{
	return compare(a, b) != 0;
}

export template<int l1, int l2> int compare(const istring<l1>& a, const iwstring<l2>& b)
{
	iwstring<l2> temp = a;
	return wcscmp(temp.c_str(), b.c_str());
}

export template<int l1, int l2> bool operator<(const istring<l1>& a, const iwstring<l2>& b)
{
	return compare(a, b) < 0;
}
...
export template<int l1, int l2> int operator!=(const istring<l1>& a, const iwstring<l2>& b)
{
	return compare(a, b) != 0;
}

export using object_name = istring<100>;
export using object_name_composed = istring<150>;
export using operation_name = istring<16>;
export using object_description = istring<200>;
export using object_path = istring<260>;
export using object_type = istring<16>;
export using string_validation_pattern = istring<100>;
export using string_validation_message = istring<100>;
export using query_body = istring<8192>;
export using file_path = istring<260>;
