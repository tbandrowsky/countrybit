...
export class grouping_header_type
{
public:
	block_id			block;
...
export template <typename KEY, typename VALUE> class grouped : protected sorted_index<KEY, relative_ptr_type, 1>
{
protected:
...
export template <typename new_type, typename item_type, typename iter_type>
