...
export module corona:store_box;
...
export struct serialized_box_data
{
	block_id		 _box_id;
	corona_size_t _size;
	corona_size_t _top;
...
export class serialized_box_memory_implementation : public serialized_box_implementation
{
...
export class serialized_box_container
{
public:
...
export class inline_box : public serialized_box_container
{
	char* stuff;
	int64_t length;
	serialized_box box;
...
export class dynamic_box : public serialized_box_container
{
	char* stuff;
