...
export module corona.database:filterable_iterator;

import :stdapi;
import :constants;

export template <typename new_key, typename value_ref> class grouped;
export template <typename new_value> class list_box;

export template <typename value_ref, typename result_type, typename iterator> auto create_array(serialized_box_container* _box, iterator, iterator, std::function<result_type(value_ref)> _fn);
export template <typename value_ref, typename result_type, typename iterator> auto create_list(serialized_box_container* _box, iterator, iterator, std::function<result_type(value_ref)> _fn);
export template <typename value_ref, typename result_type, typename iterator> auto create_grouped(serialized_box_container* _box, iterator, iterator, std::function<result_type(value_ref)> _fn);
