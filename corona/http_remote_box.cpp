...
namespace corona
{
	namespace database
	{
		...
		http_remote_box::http_remote_box(char* t, jschema* _schema, jclass* _class, jobject* _slice, int _field_idx) : boxed<http_remote_instance>(t), schema(_schema), the_class(_class), slice(_slice)
		{
			;
		}
