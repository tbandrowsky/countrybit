...
namespace flowers
{
	...
	flowers_controller::flowers_controller() : corona_controller()
	{
		box.init(1 << 22);
	...
	void flowers_controller::render_login()
	{
		;
	}

	void flowers_controller::render_registration()
	{
		;
	}

	void flowers_controller::render_password_reminder()
	{
		;
	}

	void flowers_controller::render_home()
	{
		;
	}

	void flowers_controller::render_inventory()
	{
		;
	}

	void flowers_controller::render_world()
	{
		;
	}

	void flowers_controller::render_login_contents(page_item* _frame)
	{
		;
	}

	void flowers_controller::render_registration_contents(page_item* _frame)
	{
		;
	}

	void flowers_controller::render_password_reminder_contents(page_item* _frame)
	{
		;
	}

	void flowers_controller::render_inventory_contents(page_item* _frame)
	{
		;
	}

	void flowers_controller::render_world(page_item* _frame)
	{
		;
	}

	void flowers_controller::render(const rectangle& newSize)
	{
