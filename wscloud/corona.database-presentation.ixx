...
public:
	...
	virtual void keyDown(std::shared_ptr<direct2dWindow>& win, short _key);
	virtual void keyUp(std::shared_ptr<direct2dWindow>& win, short _key);
	virtual void mouseMove(std::shared_ptr<direct2dWindow>& win, point* _point);
	virtual void mouseLeftDown(std::shared_ptr<direct2dWindow>& win, point* _point);
	virtual void mouseLeftUp(std::shared_ptr<direct2dWindow>& win, point* _point);
	virtual void mouseRightDown(std::shared_ptr<direct2dWindow>& win, point* _point);
	virtual void mouseRightUp(std::shared_ptr<direct2dWindow>& win, point* _point);
	virtual void pointSelected(std::shared_ptr<direct2dWindow>& win, point* _point, color* _color);
	virtual LRESULT ncHitTest(std::shared_ptr<direct2dWindow>& win, point* _point);
...
void presentation::keyDown(std::shared_ptr<direct2dWindow>& win, short _key)
{
	auto cp = current_page.lock();
	key_down_event kde;
	kde.control_id = 0;
...
void presentation::keyUp(std::shared_ptr<direct2dWindow>& win, short _key)
{
	auto cp = current_page.lock();
	key_up_event kde;
	kde.control_id = 0;
...
void presentation::mouseMove(std::shared_ptr<direct2dWindow>& win, point* _point)
{
	auto cp = current_page.lock();
...
void presentation::mouseLeftDown(std::shared_ptr<direct2dWindow>& win, point* _point)
{
	bool leftMouse = true;
	auto cp = current_page.lock();
	presentation* p = this;
...
void presentation::mouseLeftUp(std::shared_ptr<direct2dWindow>& win, point* _point)
{
...
void presentation::mouseRightDown(std::shared_ptr<direct2dWindow>& win, point* _point)
{
...
void presentation::mouseRightUp(std::shared_ptr<direct2dWindow>& win, point* _point)
{
...
void presentation::pointSelected(std::shared_ptr<direct2dWindow>& win, point* _point, color* _color)
{
	;
}

LRESULT presentation::ncHitTest(std::shared_ptr<direct2dWindow>& win, point* _point)
{
