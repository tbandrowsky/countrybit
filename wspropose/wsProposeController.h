...
namespace corona
{
	...
	class wsProposalController : public win32::controller {
		...
		// for sprite sheets
		void spriteSheetExportBitmap(const char* _filenameImage);
		void spriteSheetExportBitmapRectangles(const char* _filenameImage, const char* _templateFile);
